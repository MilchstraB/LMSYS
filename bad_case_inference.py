...
if __name__ == "__main__":
    ...
    # Save incorrect predictions with original data
    true_labels = data[["winner_model_a", "winner_model_b", "winner_tie"]].values
    predicted_labels = submission_df[
        ["winner_model_a", "winner_model_b", "winner_tie"]
    ].values
    ...
    incorrect_indices = true_label_indices != predicted_label_indices
    incorrect_predictions = data.loc[incorrect_indices].copy()
    incorrect_predictions.loc[:, "predicted_labels"] = predicted_label_indices[
        incorrect_indices
    ]
    incorrect_predictions.loc[:, "logits"] = result_df.loc[incorrect_indices, "logits"]
